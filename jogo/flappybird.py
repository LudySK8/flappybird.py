...
def main():
    ...
    while rodando:
        ...
        if game_over:
            ...
            tela.blit(texto_game_over, (TELA_LARGURA // 2 - texto_game_over.get_width() // 2, TELA_ALTURA // 2))
            texto_reiniciar = FONTE_PONTOS.render("Clique para reiniciar", 1, (255, 255, 255))
